...
while True:
    ...
    if hands and counterPause == 0 and modeType < 3:
        ...
        if fingers1 == [0,1,0,0,0] or fingers1 == [1,0,0,0,0]:
            if selection != 1:
                counter = 1
            selection = 1
        elif fingers1 == [0,1,1,0,0] or fingers1 == [1,1,0,0,0]:
            if selection != 2:
                counter = 1
            selection = 2
        elif fingers1 == [0,1,1,1,0] or fingers1 == [1,1,1,0,0]:
            if selection != 3:
                counter = 1
            selection = 3
        else:
